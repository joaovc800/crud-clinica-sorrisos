...
async function edit(){
    ...
    const url = route('funcionarios') + `/${cpf}`
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-6 mb-3 text-start">
                  ...
                  <input type="text" class="form-control" id="cargo" name="Cargo" value="${data.Cargo}" required>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-md-6 mb-3 text-start">
                  ...
                  <input type="date" class="form-control" id="dataAdmissao" name="DataAdmissao" value="${data.DataAdmissao}" required>
                </div>
                <div class="col-md-6 mb-3 text-start">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3 text-start">
                  ...
                  <input type="number" step="0.01" class="form-control" id="salario" name="Salario" value="${data.Salario}" required>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 mb-3 text-start">
    ...
    if(result.isConfirmed){
        ...
        NOTYF.success('Dados do funcionário alterados com sucesso')
    }
}
...
const buildRowAsDOM = (data) => {
    ...
    tr.appendChild(createCell(data.Cargo))
    tr.appendChild(createCell(data.Salario))
    tr.appendChild(createCell(data.DataAdmissao))
...
const response = await fetchApi(route(`funcionarios`))
...
buttonNew.addEventListener('click', async () => {
    ...
    if(result.isConfirmed){
      ...
      NOTYF.success('Novo funcionário cadastrado com sucesso')
    }
...
buttonDelete.addEventListener('click', () => {
    ...
    del.forEach(async d => {
        ...
        if(response.Id){
            d.closest('tr').remove()
            NOTYF.success('Dados do funcionário deletado com sucesso')
        }
    })
})
